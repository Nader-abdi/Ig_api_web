...
class Endpoints
{
    ...
    const FOLLOWERS_URL_REEL = 'https://www.instagram.com/graphql/query/?query_hash=c76146de99bb02f6415203be841dd25a&variables={variables}';
    ...
    public static function getFollowersJsonLink($accountId, $count, $after = '', $variables = null)
    {
        if ($variables === null) {
            ...
            $url = str_replace('{variables}', urlencode($variables), static::FOLLOWERS_URL_REEL);
        }
        return $url;
    }
